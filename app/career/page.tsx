...
const skills = [
  ...
  },
  {
    ...
    tags: ["Python", "PHP", "Java", "Ruby", "TypeScript", "Go", "OWASP ZAP", "OpenVAS", "OpenVuls", "Selenium等のテスト自動化ツール"],
    note: "システム全体を俯瞰した技術選定・アーキテクチャ設計・バックエンド実装。ハードウェアを含むシナリオテストの設計、テスト自動化の推進、および脆弱性評価による品質リスクの事前検知。",
  },
  {
    category: "社内SE・コーポレートIT",
    tags: ["ベンダー折衝", "要求分析", "社内NW構築", "資産管理", "PCキッティング", "PCヘルプデスク"],
    note: "関連部署からの要望・課題の吸い上げによる要件定義と、ベンダーコントロールを通じたシステム開発推進。新規自動車販売店舗オープン時のネットワーク構築フォロー、PCキッティングやIT資産管理による社内環境の整備。",
  },
];
